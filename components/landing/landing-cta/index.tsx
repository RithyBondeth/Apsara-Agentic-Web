...
export default function LandingCta({
  ...
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute left-1/2 top-1/2 h-120 w-120 -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(circle,oklch(0.78_0.11_78/0.18),transparent_72%)] blur-[170px]"
      />
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          <Button
            asChild
            size="lg"
            className="h-12 w-full rounded-full border-0 bg-[linear-gradient(135deg,oklch(0.58_0.15_67),oklch(0.67_0.14_74))] px-10 text-sm font-semibold text-white shadow-[0_18px_42px_oklch(0.67_0.14_74/0.24)] transition-transform hover:-translate-y-0.5 sm:w-auto"
          >
